...
(function() {
    ...
    run.$inject = ['$rootScope', '$state', 'Auth', 'SECURED_ROUTES'];
    /* @ngInject */
    function routerHelperProvider($locationProvider, $stateProvider, $urlRouterProvider, SECURED_ROUTES) {
        ...
        $stateProvider.stateAuthenticated = function(path, route) {
            ...
            route.resolve.arena = ['arenaService', function (arenaService) {
                return arenaService.getIdArena();
            }];
    ...
    function run($rootScope, $state, Auth, SECURED_ROUTES) {
